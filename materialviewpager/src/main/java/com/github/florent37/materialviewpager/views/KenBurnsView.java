...
public class KenBurnsView extends ImageView {
    ...
    private int mTransitionDuration = RandomTransitionGenerator.DEFAULT_TRANSITION_DURATION;
    ...
    public KenBurnsView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (theme != null) {
            ...
            TypedArray a = theme.obtainStyledAttributes(
                    attrs,
                    R.styleable.KenBurnsView,
                    0, 0);

            mTransitionDuration = a.getInteger(R.styleable.KenBurnsView_transitionDuration, mTransitionDuration);
            a.recycle();
        }
    ...
    private void startNewTransition() {
        ...
        mCurrentTrans = getTransGen().generateNextTransition(mDrawableRect, mViewportRect);
        mElapsedTime = 0;
        mLastFrameTime = System.currentTimeMillis();
    ...
    public TransitionGenerator getTransGen() {
        if (mTransGen == null) {
            mTransGen = new RandomTransitionGenerator(mTransitionDuration, new AccelerateDecelerateInterpolator());
        }
        return mTransGen;
    }
